...
import ru.stepanov.database.entity.DbCustomer;
...
public abstract class _DbCustomerSession extends CayenneDataObject {
    ...
    public static final Property<DbCustomer> SESSION_TO_CUSTOMER = Property.create("sessionToCustomer", DbCustomer.class);
    ...
    public void setSessionToCustomer(DbCustomer sessionToCustomer) {
        setToOneTarget("sessionToCustomer", sessionToCustomer, true);
    }

    public DbCustomer getSessionToCustomer() {
        return (DbCustomer)readProperty("sessionToCustomer");
    }
