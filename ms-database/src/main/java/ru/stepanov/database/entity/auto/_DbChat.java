...
/**
 * Class _DbChat was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DbChat extends CayenneDataObject {
    ...
    public static final Property<List<DbMessage>> CHAT_TO_MESSAGE = Property.create("chatToMessage", List.class);
    ...
    public void addToChatToMessage(DbMessage obj) {
        addToManyTarget("chatToMessage", obj, true);
    }
    public void removeFromChatToMessage(DbMessage obj) {
        removeToManyTarget("chatToMessage", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<DbMessage> getChatToMessage() {
        return (List<DbMessage>)readProperty("chatToMessage");
    }
