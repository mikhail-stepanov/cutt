...
import ru.stepanov.database.entity.DbCutter;

/**
 * Class _DbCutterSession was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DbCutterSession extends CayenneDataObject {
    ...
    public static final Property<DbCutter> SESSION_TO_CUTTER = Property.create("sessionToCutter", DbCutter.class);
    ...
    public void setSessionToCutter(DbCutter sessionToCutter) {
        setToOneTarget("sessionToCutter", sessionToCutter, true);
    }

    public DbCutter getSessionToCutter() {
        return (DbCutter)readProperty("sessionToCutter");
    }
