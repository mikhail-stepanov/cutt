...
public abstract class _DbUser extends CayenneDataObject {
    ...
    public static final Property<List<DbUserSession>> TCH_USER_SESSION = Property.create("tchUserSession", List.class);
    ...
    public void addToTchUserSession(DbUserSession obj) {
        addToManyTarget("tchUserSession", obj, true);
    }
    public void removeFromTchUserSession(DbUserSession obj) {
        removeToManyTarget("tchUserSession", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<DbUserSession> getTchUserSession() {
        return (List<DbUserSession>)readProperty("tchUserSession");
    }
