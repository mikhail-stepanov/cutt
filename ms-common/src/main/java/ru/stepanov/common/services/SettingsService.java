package ru.stepanov.common.services;

import ru.stepanov.common.annotations.SettingsEndpoint;
import ru.stepanov.common.annotations.SettingsMethod;
...
public class SettingsService {
    ...
    private void init(){
        ...
        for (BeanDefinition bd : scanner.findCandidateComponents("ru.stepanov")){
